...
* status = #active
* description = "Erstlinienterapie mit BCL2-Inhibitor bei CLL"
* code = $sct#725567006 "B-cell lymphoma 2 inhibitor"
* timingTiming.repeat.count = //nicht definiert in dieser Leitlinie
...
* status = #active
* description = "Erstlinienterapie mit BTK-Inhibitor bei CLL"
* code = $sct#710227007 "Non-specific protein-tyrosine kinase inhibitor"
* timingTiming.repeat.count = //nicht definiert in dieser Leitlinie